        ...
        object : Callback<R> {
            ...
            private fun Response<R>.toEither(): Either<CallError, R> {
                ...
                if (!isSuccessful) {
                    ...
                    return Failure(HttpError(code(), errorBody))
                }
                ...
                return if (successType == Unit::class.java) {
                    ...
                    Success(Unit) as Either<CallError, R>
                } else {
                    Failure(UnexpectedCallError("Response body was null"))
                }
            }
            ...
            override fun onFailure(call: Call<R?>, throwable: Throwable) {
                ...
                callback.onResponse(this@EitherCall, Response.success(Failure(error)))
            }
        }
    )
